...
<div class="html-only" style="text-align: center;">
    <div class="title" style="text-align: center;">
        ...
        Geschäftsordnung des TFVSH e.V.
    </div>
    ...
    <p>
        <a href="./../assets/pdf/geschaeftsordnung.pdf" target="_blank">Download als PDF</a><br />
        <a href="https://github.com/TFVSH/tfvsh-docs/blob/main/docs/geschaeftsordnung.md" target="_blank">GitHub Repository</a>
    </p>
...
2. Deligiertenversammlungen sind nicht öffentlich. Auf Antrag und Beschluss der Versammlung kann Öffentlichkeit
   zugelassen werden.
...
2. Bei 0–20 gemeldeten Spieler darf ein Verein oder eine Spielvereinigung einen Deligierten schicken. Für 21–40
   Mitlgieder darf ein Verein zwei Deligierte stellen, usw.
3. Die maximale Zahl der Deligierten liegt bei acht.
